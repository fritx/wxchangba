 ...
 * MIT Licensed
 */
// https://github.com/xiatian/wx-connect
...
// hack补充 wx-connect库
var message = require('wx-connect/lib/message');
var signature = require('wx-connect/lib/signature');
...
function wxConnect(config) {
  ...
  app.use(function(req, res, next) {
    ...
    // 加入voice处理
    if (req.message.msgType == 'voice' && app.voice) {
      return app.voice.call(app, req, res, next);
    }
